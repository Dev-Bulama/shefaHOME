...
/**
 * Removes all placeholder/demo properties and estates that were seeded
 * during initial setup, leaving only the 4 real Shefa Homes properties.
 * Re-runs the 4 real properties insert in case migration 000001 was skipped.
 */
return new class extends Migration
{
    /** Slugs that belong to the 4 real properties — never delete these */
    private array $keepSlugs = [
    ...
    /** Slugs of the real estates — never delete these */
    private array $keepEstateSlugs = [
        'papalantoro-estate',
        'mojoda-estate',
        'belmont-estate',
        'aurelia-estate',
    ...
    public function up(): void
    {
        ...
        // ── Delete ALL placeholder properties not in our keep list ────────────
        DB::table('properties')
            ->whereNotIn('slug', $this->keepSlugs)
            ->delete();

        // ── Delete placeholder estates not in our keep list ───────────────────
        DB::table('estates')
            ->whereNotIn('slug', $this->keepEstateSlugs)
            ->delete();

        // ── Ensure the 4 real estates exist (idempotent) ──────────────────────
        $estates = [
            ['name'=>'Papalantoro Estate','slug'=>'papalantoro-estate','state'=>'Ogun',
             'description'=>'A strategic land asset in the fast-rising growth corridor of Papalantoro, Ifo — just 48km to Ikeja.','cover_image'=>'','is_active'=>1,'created_at'=>$now,'updated_at'=>$now],
            ['name'=>'Mojoda Estate',     'slug'=>'mojoda-estate',     'state'=>'Lagos',
             'description'=>"Premium coastal investment in the thriving Epe corridor — near the Dangote Refinery, Epe Resort & Spa, and key institutions.",'cover_image'=>'','is_active'=>1,'created_at'=>$now,'updated_at'=>$now],
            ['name'=>'Belmont Estate',    'slug'=>'belmont-estate',    'state'=>'Lagos',
             'description'=>'An exclusive mini estate positioned beyond the Dangote Refinery axis, Ode-Omi, within the Ibeju-Lekki corridor.','cover_image'=>'','is_active'=>1,'created_at'=>$now,'updated_at'=>$now],
            ['name'=>'Aurelia Estate',    'slug'=>'aurelia-estate',    'state'=>'Lagos',
             'description'=>'A prime investment address in the high-growth Ibeju-Lekki corridor near the Dangote Refinery and Lekki Free Trade Zone.','cover_image'=>'','is_active'=>1,'created_at'=>$now,'updated_at'=>$now],
        ];
        ...
        // ── Ensure the 4 real properties exist (idempotent) ──────────────────
        $properties = [
            [
                ...
                'price_from'        => 1000000.00, 'price_to' => 1500000.00,
...
<p><em>Shefa Homes &amp; Properties — Where every home tells a story.</em></p>',
            ...
            [
                ...
                'price_from'        => 6000000.00, 'price_to' => 8000000.00,
                'status'            => 'available', 'is_featured' => 1,
...
<p><em>Shefa Homes &amp; Properties — Building Assets. Securing Futures.</em></p>",
            ...
            [
                ...
                'price_from'        => 0.00, 'price_to' => null,
                'status'            => 'sold_out', 'is_featured' => 1,
...
<p><em>Shefa Homes &amp; Properties — Building Assets. Securing Futures.</em></p>',
            ...
            [
                ...
                'price_from'        => 0.00, 'price_to' => null,
                'status'            => 'coming_soon', 'is_featured' => 1,
