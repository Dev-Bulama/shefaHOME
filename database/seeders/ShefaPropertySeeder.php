...
class ShefaPropertySeeder extends Seeder {
    public function run(): void {
        $landType = PropertyType::where('name', 'Residential Land')->first();
        if (! $landType) {
            $landType = PropertyType::first();
        }

        $properties = [

            // ── 1. Papalantoro Estate ─────────────────────────────────────────────
            [
                ...
                'description'       => '
<p>A Strategic Land Asset by Shefa Homes &amp; Properties</p>
...
',
            ...
            [
                ...
                'description'       => '
<p>Premium Coastal Investment by Shefa Homes &amp; Properties</p>
...
',
            ...
            // ── 3. Belmont Estate, Ode-Omi (SOLD OUT) ───────────────────────────
            [
...
',
            ...
            // ── 4. Aurelia Estate, Ibeju-Lekki (COMING SOON) ────────────────────
            [
...
',
        ...
        foreach ($properties as $p) {
            $estate = Estate::where('slug', $p['estate_slug'])->first();
