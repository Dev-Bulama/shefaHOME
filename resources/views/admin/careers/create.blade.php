...
<div class="space-y-6">
    <div class="flex items-center justify-between">
        <h1 class="text-xl font-bold text-gray-800">Post New Job</h1>
        <a href="{{ route('admin.careers.index') }}" class="text-sm text-gray-500 hover:text-gray-700">← Back</a>
    </div>

    <form method="POST" action="{{ route('admin.careers.store') }}" id="careerForm">
        @csrf
        @include('admin.careers._form', ['job' => null])
