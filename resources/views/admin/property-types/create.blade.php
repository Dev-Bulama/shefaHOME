...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-3">
        ...
        <div>
            <h2 class="text-xl font-bold text-[#1A237E]">Add Property Type</h2>
            ...
            <div>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <div id="iconPreviewBox"
                         class="w-12 h-12 bg-[#1A237E]/5 rounded-xl flex items-center justify-center text-2xl border border-gray-200 flex-shrink-0 transition-all">
                        ?
                    </div>
                </div>
