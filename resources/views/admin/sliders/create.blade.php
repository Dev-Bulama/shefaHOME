...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center justify-between">
        <h1 class="text-xl font-bold text-gray-800">Add New Slider</h1>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6 space-y-5">
            ...
            <div>
                ...
                <div class="border-2 border-dashed border-gray-200 rounded-xl p-6 text-center">
                    ...
                    <p id="sliderPlaceholder" class="text-gray-400 text-sm mb-3">Recommended: 1920 × 800px</p>
                    <input type="file" name="image" id="sliderImage" accept="image/*" required
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="text" name="cta_text" value="{{ old('cta_text') }}" placeholder="e.g. View Properties"
                        class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-amber-400 focus:outline-none"/>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-1">CTA Link URL</label>
                    <input type="text" name="cta_url" value="{{ old('cta_url') }}" placeholder="/properties"
                        class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-amber-400 focus:outline-none"/>
                </div>
            </div>
