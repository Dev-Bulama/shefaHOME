...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
        <div>
            <h2 class="text-[#0A1628] text-2xl font-bold font-['Playfair_Display']">My Documents</h2>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 py-20 px-8 text-center">
        <div class="max-w-sm mx-auto">
            ...
            <h3 class="text-[#0A1628] text-xl font-bold font-['Playfair_Display'] mb-2">No Documents Yet</h3>
    ...
    @php
        $typeConfig = [
            ...
            'c_of_o'           => ['label' => 'C of O',           'color' => 'bg-[#C9A84C]/10 text-[#b8963e]', 'icon_color' => 'text-[#C9A84C]'],
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 hover:shadow-md transition-all duration-200 p-5 group">
            ...
            {{-- Document Info --}}
            <div class="mb-4">
                <h4 class="text-[#0A1628] font-bold text-sm leading-snug mb-1 line-clamp-2">
            ...
            <div class="flex items-center justify-between pt-3 border-t border-gray-100">
                ...
                <a href="{{ route('client.documents.download', $document->id) }}"
                   class="inline-flex items-center gap-1.5 bg-[#0A1628] hover:bg-[#152238] text-white text-xs font-semibold px-3 py-1.5 rounded-lg transition-colors">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        <div class="bg-[#0A1628]/5 border-b border-gray-100 px-6 py-4 flex items-center gap-3">
            <div class="w-8 h-8 bg-[#C9A84C]/10 rounded-lg flex items-center justify-center">
                <svg class="w-4 h-4 text-[#C9A84C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/>
                </svg>
            </div>
            <div>
                <h3 class="text-[#0A1628] font-bold text-base font-['Playfair_Display']">Upload Supporting Documents</h3>
            ...
            <form action="{{ route('client.documents.upload') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-5 mb-5">
                    <div>
                        ...
                        <select name="document_type" required
                                class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-700 focus:ring-2 focus:ring-[#C9A84C]/30 focus:border-[#C9A84C] outline-none bg-white">
                    ...
                    <div>
                        ...
                        <input type="text" name="title"
                               ...
                               class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm text-gray-700 focus:ring-2 focus:ring-[#C9A84C]/30 focus:border-[#C9A84C] outline-none">
                    </div>
                </div>
                ...
                <div class="mb-5">
                    ...
                    <div class="border-2 border-dashed rounded-xl p-8 text-center cursor-pointer transition-colors"
                         :class="dragOver ? 'border-[#C9A84C] bg-[#C9A84C]/5' : 'border-gray-200 hover:border-[#C9A84C]/50 hover:bg-gray-50'"
                        ...
                        <template x-for="(file, index) in files" :key="index">
                            <div class="flex items-center justify-between bg-gray-50 border border-gray-100 rounded-lg px-3 py-2">
                                <div class="flex items-center gap-2 min-w-0">
                                    <svg class="w-4 h-4 text-[#C9A84C] flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
                ...
                <div class="flex items-center gap-3">
                    <button type="submit"
                            class="inline-flex items-center gap-2 bg-[#C9A84C] hover:bg-[#b8963e] text-white font-semibold px-6 py-3 rounded-xl transition-colors text-sm shadow-md shadow-[#C9A84C]/20">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12"/>
                        </svg>
                        Upload Document(s)
