<footer class="bg-[#1A237E] text-white">
            ...
            <div class="lg:col-span-1">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <a href="{{ $settings['social_facebook'] ?? '#' }}"
                       ...
                       aria-label="Facebook">
                        <svg class="w-4 h-4 text-gray-400 group-hover:text-[#1A237E]" fill="currentColor" viewBox="0 0 24 24">
                ...
                <ul class="space-y-3">
                    <li>
                        <a href="{{ route('properties.index') }}"
                           class="text-gray-400 hover:text-[#27AE22] text-sm transition-colors flex items-center gap-2 group">
                            <span class="w-1.5 h-1.5 rounded-full bg-[#27AE22]/40 group-hover:bg-[#27AE22] transition-colors flex-shrink-0"></span>
                            All Properties
                        </a>
                    </li>
                    <li>
            ...
            <div>
                ...
                <ul class="space-y-3.5 mb-7">
                    <li class="flex items-start gap-3">
                        <div class="w-7 h-7 bg-[#27AE22]/10 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                    ...
                    <form x-show="!success" @submit.prevent="submit()" class="space-y-2">
                        <div class="relative">
                            <input type="email"
                                   ...
                                   class="w-full bg-white/10 border border-white/20 rounded-xl px-4 py-2.5 text-sm text-white placeholder-gray-500 focus:outline-none focus:border-[#27AE22] transition-colors">
                        </div>
                        <div x-show="error" class="text-red-400 text-xs" x-text="error"></div>
                        <button type="submit"
                                :disabled="loading"
                                class="w-full bg-[#27AE22] hover:bg-[#4ADE80] text-[#1A237E] font-semibold py-2.5 px-4 rounded-xl text-sm transition-all duration-200 hover:-translate-y-0.5 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5">
            <div class="flex flex-col sm:flex-row items-center justify-between gap-4">
                <p class="text-gray-500 text-sm text-center sm:text-left">
                    &copy; {{ date('Y') }} <span class="text-[#27AE22] font-medium">SHEFAHOMES</span>. All rights reserved. Built with excellence in Nigeria.
                </p>
                <div class="flex items-center gap-5">
                    <a href="{{ route('privacy') }}"
                       class="text-gray-500 hover:text-[#27AE22] text-xs transition-colors">
                        Privacy Policy
                    </a>
