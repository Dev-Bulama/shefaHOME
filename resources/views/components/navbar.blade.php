<nav x-data="{
    ...
    :class="scrolled
        ? 'bg-[#0A1628] shadow-xl shadow-black/20'
        : 'bg-transparent'"
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-20">
            ...
            <a href="{{ route('home') }}" class="flex items-center gap-2.5 group flex-shrink-0">
                <div class="w-9 h-9 bg-[#C9A84C] rounded-xl flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform duration-200">
                ...
                <div>
                    ...
                    <span class="text-[#C9A84C] text-xs leading-none tracking-widest uppercase">Premium Real Estate</span>
                </div>
            </a>
            ...
            <div class="hidden lg:flex items-center gap-1">
                ...
                <a href="{{ route('home') }}"
                   class="px-4 py-2 text-sm font-medium rounded-lg transition-colors duration-200
                          {{ request()->routeIs('home') ? 'text-[#C9A84C]' : 'text-gray-200 hover:text-white hover:bg-white/10' }}">
                    Home
                </a>
                ...
                <div class="relative" x-data="{ open: false }" @mouseenter="open=true" @mouseleave="open=false">
                    <button class="flex items-center gap-1 px-4 py-2 text-sm font-medium rounded-lg transition-colors duration-200
                                   {{ request()->routeIs('properties*') ? 'text-[#C9A84C]' : 'text-gray-200 hover:text-white hover:bg-white/10' }}">
                        Properties
                ...
                <a href="{{ route('virtual-tour') }}"
                   class="px-4 py-2 text-sm font-medium rounded-lg transition-colors duration-200
                          {{ request()->routeIs('virtual-tour') ? 'text-[#C9A84C]' : 'text-gray-200 hover:text-white hover:bg-white/10' }}">
                    Virtual Tour
                </a>
                ...
                <a href="{{ route('contact') }}"
                   class="px-4 py-2 text-sm font-medium rounded-lg transition-colors duration-200
                          {{ request()->routeIs('contact') ? 'text-[#C9A84C]' : 'text-gray-200 hover:text-white hover:bg-white/10' }}">
                    Contact
                </a>
            </div>
            ...
            <div class="hidden lg:flex items-center gap-3">
                <a href="{{ route('login', ['portal' => 'investor']) }}"
                   class="px-5 py-2 text-sm font-semibold text-[#C9A84C] border border-[#C9A84C]/60 rounded-full hover:bg-[#C9A84C]/10 hover:border-[#C9A84C] transition-all duration-200">
                    Investor Portal
                </a>
                <a href="{{ route('login') }}"
                   class="px-5 py-2 text-sm font-semibold bg-[#C9A84C] text-[#0A1628] rounded-full hover:bg-[#E8C97A] transition-all duration-200 shadow-lg shadow-[#C9A84C]/20 hover:shadow-[#C9A84C]/40 hover:-translate-y-0.5">
                    Client Login
                </a>
            </div>
    ...
    <div x-show="mobileOpen"
         ...
         class="lg:hidden bg-[#0A1628] border-t border-white/10 shadow-2xl"
         style="display:none;">
        ...
        <div class="max-w-7xl mx-auto px-4 py-4 space-y-1">
            ...
            <a href="{{ route('home') }}"
               ...
               class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-colors
                      {{ request()->routeIs('home') ? 'text-[#C9A84C] bg-[#C9A84C]/10' : 'text-gray-200 hover:text-white hover:bg-white/10' }}">
            ...
            <div x-data="{ propertiesMobileOpen: false }">
                <button @click="propertiesMobileOpen=!propertiesMobileOpen"
                        class="w-full flex items-center justify-between gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-colors
                               {{ request()->routeIs('properties*') ? 'text-[#C9A84C] bg-[#C9A84C]/10' : 'text-gray-200 hover:text-white hover:bg-white/10' }}">
                ...
                <div x-show="propertiesMobileOpen" x-transition class="mt-1 ml-4 pl-4 border-l border-white/10 space-y-1">
                    <a href="{{ route('properties.index') }}" @click="mobileOpen=false" class="block px-3 py-2 text-sm text-gray-300 hover:text-[#C9A84C] rounded-lg transition-colors">All Properties</a>
            ...
            <a href="{{ route('virtual-tour') }}"
               @click="mobileOpen=false"
               class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-colors
                      {{ request()->routeIs('virtual-tour') ? 'text-[#C9A84C] bg-[#C9A84C]/10' : 'text-gray-200 hover:text-white hover:bg-white/10' }}">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('blog.index') }}"
               @click="mobileOpen=false"
               class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-colors
                      {{ request()->routeIs('blog*') ? 'text-[#C9A84C] bg-[#C9A84C]/10' : 'text-gray-200 hover:text-white hover:bg-white/10' }}">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('contact') }}"
               @click="mobileOpen=false"
               class="flex items-center gap-3 px-4 py-3 rounded-xl text-sm font-medium transition-colors
                      {{ request()->routeIs('contact') ? 'text-[#C9A84C] bg-[#C9A84C]/10' : 'text-gray-200 hover:text-white hover:bg-white/10' }}">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div class="pt-3 pb-2 border-t border-white/10 grid grid-cols-2 gap-3">
                <a href="{{ route('login', ['portal' => 'investor']) }}"
                   @click="mobileOpen=false"
                   class="flex items-center justify-center px-4 py-2.5 text-sm font-semibold text-[#C9A84C] border border-[#C9A84C]/60 rounded-xl hover:bg-[#C9A84C]/10 transition-colors">
                    Investor Portal
                </a>
                <a href="{{ route('login') }}"
                   @click="mobileOpen=false"
                   class="flex items-center justify-center px-4 py-2.5 text-sm font-semibold bg-[#C9A84C] text-[#0A1628] rounded-xl hover:bg-[#E8C97A] transition-colors shadow-lg">
                    Client Login
                </a>
            </div>
        </div>
