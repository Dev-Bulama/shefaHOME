...
<div class="flex h-screen overflow-hidden">
        ...
        <nav class="flex-1 px-2 py-4 space-y-0.5">
            ...
            <a href="{{ route('admin.navigation.index') }}"
               class="sidebar-link {{ request()->routeIs('admin.navigation*') ? 'active' : '' }}">
                ...
                <span x-show="sidebarOpen">Navigation</span>
            </a>
    ...
    <aside x-show="mobileOpen"
        ...
        <nav class="flex-1 px-2 py-4 space-y-0.5">
            ...
            <a href="{{ route('admin.gallery.index') }}" class="sidebar-link">Gallery</a>
            <a href="{{ route('admin.media.index') }}" class="sidebar-link">Media Library</a>
