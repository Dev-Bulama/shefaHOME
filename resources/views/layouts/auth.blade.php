...
<div class="min-h-screen flex">
    ...
    <div class="hidden lg:flex lg:w-1/2 xl:w-5/12 auth-image-panel relative flex-col justify-between p-10 overflow-hidden">
        ...
        <div class="absolute inset-0 opacity-10 pointer-events-none">
            <div class="absolute top-0 right-0 w-64 h-64 border border-[#C9A84C]/30 rounded-full -translate-y-32 translate-x-32"></div>
            <div class="absolute bottom-0 left-0 w-96 h-96 border border-[#C9A84C]/20 rounded-full translate-y-48 -translate-x-48"></div>
        </div>

        {{-- Top: Logo --}}
        <div class="relative z-10">
            <a href="{{ route('home') }}" class="flex items-center gap-3 w-fit">
                <div class="w-10 h-10 bg-[#C9A84C] rounded-xl flex items-center justify-center shadow-lg">
        ...
        <div class="relative z-10">
            ...
            <h2 class="font-display text-white text-3xl xl:text-4xl font-bold leading-tight mb-4">
                Building Dreams<br>
                <span class="text-[#C9A84C]">Across Nigeria</span>
            </h2>
            ...
            <div class="flex items-center gap-6 mt-8">
                <div class="text-center">
                    <p class="text-[#C9A84C] font-display font-bold text-2xl">500+</p>
                    <p class="text-gray-400 text-xs mt-0.5">Properties Sold</p>
                </div>
                <div class="w-px h-10 bg-white/20"></div>
                <div class="text-center">
                    <p class="text-[#C9A84C] font-display font-bold text-2xl">15+</p>
                    <p class="text-gray-400 text-xs mt-0.5">Years Experience</p>
                </div>
                <div class="w-px h-10 bg-white/20"></div>
                <div class="text-center">
                    <p class="text-[#C9A84C] font-display font-bold text-2xl">98%</p>
        ...
        <div class="relative z-10">
            <div class="bg-white/10 backdrop-blur-sm border border-white/20 rounded-2xl p-5">
                <div class="flex items-start gap-3">
                    <svg class="w-6 h-6 text-[#C9A84C] flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                        ...
                        <div class="flex items-center gap-2 mt-3">
                            <img src="https://ui-avatars.com/api/?name=Amara+O&background=C9A84C&color=0A1628&size=32"
    ...
    <div class="flex-1 flex flex-col justify-center items-center px-6 py-10 lg:px-12 xl:px-16 bg-white relative overflow-y-auto">
        ...
        <div class="lg:hidden mb-8 text-center">
            <a href="{{ route('home') }}" class="inline-flex items-center gap-2">
                <div class="w-9 h-9 bg-[#0A1628] rounded-xl flex items-center justify-center">
                    <svg class="w-5 h-5 text-[#C9A84C]" fill="currentColor" viewBox="0 0 20 20">
                        <path d="M10.707 2.293a1 1 0 00-1.414 0l-7 7a1 1 0 001.414 1.414L4 10.414V17a1 1 0 001 1h2a1 1 0 001-1v-2a1 1 0 011-1h2a1 1 0 011 1v2a1 1 0 001 1h2a1 1 0 001-1v-6.586l.293.293a1 1 0 001.414-1.414l-7-7z"/>
                    </svg>
                </div>
                <span class="font-display font-bold text-[#0A1628] text-xl tracking-wide">SHEFAHOMES</span>
            </a>
        </div>
        ...
        <div class="mt-8 text-center">
            <a href="{{ route('home') }}" class="text-xs text-gray-400 hover:text-[#0A1628] transition-colors inline-flex items-center gap-1">
