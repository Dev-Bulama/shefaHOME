{{-- Newsletter --}}
<section class="py-20 bg-[#C9A84C] relative overflow-hidden">
    {{-- Decorative elements --}}
    <div class="absolute inset-0 opacity-10">
        <div class="absolute top-0 right-0 w-64 h-64 bg-[#0A1628] rounded-full translate-x-1/3 -translate-y-1/2"></div>
        <div class="absolute bottom-0 left-0 w-96 h-96 bg-[#0A1628] rounded-full -translate-x-1/3 translate-y-1/2"></div>
    </div>
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center"
        ...
        {{-- Icon --}}
        <div class="inline-flex items-center justify-center w-16 h-16 bg-[#0A1628]/15 rounded-2xl mb-6">
            <svg class="w-8 h-8 text-[#0A1628]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <p class="text-[#0A1628]/70 text-lg mb-10 max-w-xl mx-auto">
            Get exclusive property listings, investment insights and special offers delivered to your inbox. No spam, ever.
        </p>

        {{-- Success state --}}
        <div x-show="success" x-transition class="bg-[#0A1628] text-white rounded-2xl p-6 mb-6 inline-flex items-center gap-3">
        ...
        <div x-show="!success">
            <div class="flex flex-col sm:flex-row gap-3 max-w-lg mx-auto">
                <input type="email"
                       ...
                       class="flex-1 bg-white/90 backdrop-blur border-0 text-[#0A1628] placeholder-gray-400 px-6 py-4 rounded-2xl focus:outline-none focus:ring-4 focus:ring-[#0A1628]/20 text-base shadow-md">
                <button @click="subscribe()"
                        :disabled="loading"
                        class="flex-shrink-0 bg-[#0A1628] hover:bg-[#1a2d4a] text-white font-bold px-8 py-4 rounded-2xl transition-all hover:scale-105 shadow-md disabled:opacity-70 disabled:cursor-not-allowed flex items-center gap-2 justify-center">
        ...
        {{-- Trust signals --}}
        <div class="mt-10 flex flex-wrap items-center justify-center gap-8 text-[#0A1628]/60 text-sm">
