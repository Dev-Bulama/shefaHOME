...
<section class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-14" data-reveal>
            <span class="inline-block text-[#27AE22] font-semibold text-sm tracking-widest uppercase mb-3">Trust & Credibility</span>
            <h2 class="font-display text-4xl md:text-5xl font-bold text-[#1A237E] mb-4">
                Trusted Partners &amp; <span class="text-[#27AE22]">Recognitions</span>
            </h2>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6">
            ...
            <div class="bg-white rounded-2xl p-6 text-center shadow-sm border border-gray-100 hover:shadow-md hover:border-[#27AE22]/30 transition-all hover:-translate-y-1 group"
                ...
                @else
                <div class="w-14 h-14 mx-auto mb-4 bg-gradient-to-br from-[#27AE22]/20 to-[#27AE22]/10 rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
                ...
                @endif
                <h4 class="font-bold text-[#1A237E] text-sm mb-1 leading-snug">{{ $award->title }}</h4>
                @if($award->year)
                <p class="text-[#27AE22] text-xs font-semibold">{{ $award->year }}</p>
                @endif
