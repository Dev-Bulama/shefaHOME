...
<section class="relative bg-[#0A1628] py-28 overflow-hidden">
    <div class="absolute inset-0">
        ...
        <div class="absolute bottom-0 right-0 w-1/2 h-full opacity-10"
             style="background:radial-gradient(circle at 80% 50%, #C9A84C 0%, transparent 60%)"></div>
    </div>
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="max-w-3xl">
            <span class="inline-block text-[#C9A84C] font-semibold text-sm tracking-widest uppercase mb-4">Strategic Partnerships</span>
            <h1 class="font-display text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
                Joint Venture<br><span class="text-[#C9A84C]">Partnerships</span>
            </h1>
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-2xl mx-auto mb-14" data-reveal>
            <span class="inline-block text-[#C9A84C] font-semibold text-sm tracking-widest uppercase mb-3">Why Partner With Us</span>
            <h2 class="font-display text-4xl font-bold text-[#0A1628] mb-4">We bring structure, expertise,<br>and execution power</h2>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div class="flex items-start gap-4 p-5 rounded-2xl border border-gray-100 hover:border-[#C9A84C]/30 hover:shadow-md transition-all" data-reveal>
...
<section class="py-20 bg-[#0A1628]">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-2xl mx-auto mb-14" data-reveal>
            <span class="inline-block text-[#C9A84C] font-semibold text-sm tracking-widest uppercase mb-3">Our JV Models</span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="bg-white/5 border border-white/10 rounded-3xl p-8 hover:bg-white/8 transition-all" data-reveal>
                ...
                <p class="text-[#C9A84C] text-sm font-medium mb-4">You contribute land. We handle development.</p>
                <ul class="space-y-3 text-gray-400 text-sm">
                    <li class="flex items-start gap-2">
                        <svg class="w-4 h-4 text-[#C9A84C] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {{-- Investor --}}
            <div class="bg-[#C9A84C] rounded-3xl p-8 relative overflow-hidden" data-reveal style="transition-delay:150ms">
                ...
                <h3 class="font-display text-xl font-bold text-[#0A1628] mb-2">Investor Partnership</h3>
                <p class="text-[#0A1628]/70 text-sm font-medium mb-4">You provide capital. We manage execution.</p>
                <ul class="space-y-3 text-[#0A1628]/80 text-sm">
                    <li class="flex items-start gap-2">
                        <svg class="w-4 h-4 text-[#0A1628] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                        </svg>
            ...
            <div class="bg-white/5 border border-white/10 rounded-3xl p-8 hover:bg-white/8 transition-all" data-reveal style="transition-delay:300ms">
                ...
                <p class="text-[#C9A84C] text-sm font-medium mb-4">Land + Capital collaboration model.</p>
                <ul class="space-y-3 text-gray-400 text-sm">
                    <li class="flex items-start gap-2">
                        <svg class="w-4 h-4 text-[#C9A84C] mt-0.5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
...
<section class="py-20 bg-gray-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center max-w-2xl mx-auto mb-14" data-reveal>
            <span class="inline-block text-[#C9A84C] font-semibold text-sm tracking-widest uppercase mb-3">Our Process</span>
            <h2 class="font-display text-4xl font-bold text-[#0A1628] mb-4">How a JV Partnership Works</h2>
        </div>
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach([
            ...
            <div class="bg-white rounded-2xl p-6 border border-gray-100 hover:shadow-md transition-all relative overflow-hidden" data-reveal>
                ...
                <div class="w-8 h-8 bg-[#C9A84C] rounded-lg flex items-center justify-center mb-4">
                    <span class="text-[#0A1628] font-bold text-xs">{{ $step }}</span>
                </div>
                <h3 class="font-semibold text-[#0A1628] mb-2 text-base">{{ $title }}</h3>
...
<section class="py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div data-reveal>
                <span class="inline-block text-[#C9A84C] font-semibold text-sm tracking-widest uppercase mb-3">What You Can Expect</span>
                <h2 class="font-display text-4xl font-bold text-[#0A1628] mb-8 leading-tight">A partnership built on trust and results</h2>
                <div class="space-y-4">
                    @foreach([
                    ...
                    <div class="flex items-start gap-3">
                        <div class="w-6 h-6 bg-[#C9A84C]/15 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
            ...
            <div class="bg-[#0A1628] rounded-3xl p-8 lg:p-10 text-white" data-reveal style="transition-delay:200ms">
                ...
                <div class="space-y-3" id="jv-consultation">
                    <a href="{{ route('contact') }}"
                       class="flex items-center gap-3 w-full bg-[#C9A84C] text-[#0A1628] font-semibold px-6 py-3.5 rounded-xl hover:bg-[#E8C97A] transition-all text-sm">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z"/>
                        </svg>
                        Book a JV Consultation
