...
<section class="relative bg-[#0A1628] py-28 overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <span class="inline-block text-[#C9A84C] font-semibold text-sm tracking-widest uppercase mb-4">What We Do</span>
        <h1 class="font-display text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight">
            Our <span class="text-[#C9A84C]">Services</span>
        </h1>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="space-y-24">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center" data-reveal>
                <div>
                    <div class="w-14 h-14 bg-[#C9A84C]/15 rounded-2xl flex items-center justify-center mb-6">
                        <svg class="w-7 h-7 text-[#C9A84C]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>
                        </svg>
                    </div>
                    <h2 class="font-display text-3xl font-bold text-[#0A1628] mb-4">Land Banking Investment</h2>
                    ...
                    <div class="space-y-3 mb-8">
                        ...
                        <div class="flex items-center gap-3">
                            <div class="w-5 h-5 bg-[#C9A84C]/15 rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    <p class="text-[#C9A84C] font-semibold italic">Secure today. Multiply tomorrow.</p>
                </div>
                <div class="bg-gradient-to-br from-[#0A1628] to-[#1a2e50] rounded-3xl p-10 text-white flex flex-col justify-center min-h-[280px]">
                    <p class="text-4xl font-bold text-[#C9A84C] mb-2">Prime</p>
            ...
            {{-- Project Management --}}
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center" data-reveal>
                <div class="bg-[#C9A84C] rounded-3xl p-10 text-[#0A1628] order-2 lg:order-1 flex flex-col justify-center min-h-[280px]">
                    <p class="text-4xl font-bold mb-2">End-to-End</p>
                    <p class="text-xl font-semibold mb-3">Project Oversight</p>
                    <p class="text-[#0A1628]/70 text-sm leading-relaxed">From acquisition to final handover, every project under our management meets professional standards on time and within budget.</p>
                </div>
                <div class="order-1 lg:order-2">
                    <div class="w-14 h-14 bg-[#0A1628]/8 rounded-2xl flex items-center justify-center mb-6">
                        <svg class="w-7 h-7 text-[#0A1628]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01"/>
                        </svg>
                    </div>
                    <h2 class="font-display text-3xl font-bold text-[#0A1628] mb-4">Project Management</h2>
                    <p class="text-gray-500 text-base leading-relaxed mb-6">
                    ...
                    <p class="text-[#C9A84C] font-semibold italic">We protect your capital while delivering excellence.</p>
                </div>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center" data-reveal>
                <div>
                    ...
                    <h2 class="font-display text-3xl font-bold text-[#0A1628] mb-4">Property Flipping Management</h2>
                    <p class="text-gray-500 text-base leading-relaxed mb-6">
                    ...
                    <p class="text-[#C9A84C] font-semibold italic">Designed for investors seeking high-yield returns.</p>
                </div>
                <div class="bg-gradient-to-br from-[#0A1628] to-[#1a2e50] rounded-3xl p-10 text-white flex flex-col justify-center min-h-[280px]">
                    <p class="text-4xl font-bold text-[#C9A84C] mb-2">Maximise</p>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center" data-reveal>
                <div class="bg-[#C9A84C] rounded-3xl p-10 text-[#0A1628] order-2 lg:order-1 flex flex-col justify-center min-h-[280px]">
                    ...
                    <p class="text-[#0A1628]/70 text-sm leading-relaxed">We collaborate with landowners and investors through structured, transparent JV agreements designed for mutual growth.</p>
                </div>
                <div class="order-1 lg:order-2">
                    <div class="w-14 h-14 bg-[#0A1628]/8 rounded-2xl flex items-center justify-center mb-6">
                        <svg class="w-7 h-7 text-[#0A1628]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h2 class="font-display text-3xl font-bold text-[#0A1628] mb-4">Joint Venture Partnerships</h2>
                    <p class="text-gray-500 text-base leading-relaxed mb-6">
                    ...
                    <a href="{{ route('joint-venture') }}" class="inline-flex items-center gap-2 text-[#C9A84C] font-semibold text-sm hover:underline">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center" data-reveal>
                <div>
                    ...
                    <h2 class="font-display text-3xl font-bold text-[#0A1628] mb-4">Property Development</h2>
                    <p class="text-gray-500 text-base leading-relaxed mb-6">
                    ...
                    <p class="text-[#C9A84C] font-semibold italic">We build assets that appreciate.</p>
                </div>
                <div class="bg-gradient-to-br from-[#0A1628] to-[#1a2e50] rounded-3xl p-10 text-white flex flex-col justify-center min-h-[280px]">
                    <p class="text-4xl font-bold text-[#C9A84C] mb-2">Investment-Ready</p>
...
<section class="py-20 bg-gray-50">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <span class="inline-block text-[#C9A84C] font-semibold text-sm tracking-widest uppercase mb-4">Ready to Get Started?</span>
        <h2 class="font-display text-4xl font-bold text-[#0A1628] mb-5">Let's Build Something Together</h2>
        ...
        <div class="flex flex-wrap justify-center gap-4">
            <a href="{{ route('contact') }}"
               class="bg-[#0A1628] text-white font-bold px-8 py-4 rounded-full hover:bg-[#0A1628]/90 transition-all hover:scale-105">
                Contact Us
            </a>
            <a href="{{ route('joint-venture') }}"
               class="border-2 border-[#C9A84C] text-[#C9A84C] font-bold px-8 py-4 rounded-full hover:bg-[#C9A84C] hover:text-[#0A1628] transition-all">
                Explore JV Partnerships
            </a>
            <a href="{{ route('investor-info') }}"
               class="border-2 border-[#0A1628] text-[#0A1628] font-bold px-8 py-4 rounded-full hover:bg-[#0A1628] hover:text-white transition-all">
